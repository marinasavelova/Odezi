...
<div class="sign-up-container">
	...
	<div class="middle-sign-up">
		<div class="block-flat">
			...
			@endif
				<form style="margin-bottom: 0px !important;" class="form-horizontal" method="POST" action="{{ url('/auth/register') }}" parsley-validate novalidate>
							...
							<div class="form-group">
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" name="name" parsley-trigger="change" parsley-error-container="#name-error" required placeholder="Username" value="{{ old('name') }}" class="form-control">
									</div>
							...
							<div class="form-group">
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="email" name="email" parsley-trigger="change" parsley-error-container="#email-error" required placeholder="E-mail" value="{{ old('email') }}" class="form-control">
									</div>

        ...
        <div class="col-md-12">
            ...
            <div class="content">
               @if ($errors->all())
                ...
                @endif
              <form id="store-form" class="form-horizontal group-border-dashed" style="border-radius: 0px;" role="form" action="{{ route('admin.stores.update', $store->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input parsley-type="url" type="url" class="form-control" id="url" value="{{$store->url}}" name="url" required="" placeholder="URL" data-parsley-id="7745"><ul class="parsley-errors-list" id="parsley-id-7745"></ul>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                            <img class="" src="{{ asset("$store->img") }}" alt=""/>
                        </div>
                        <div>
               ...
               <?php $countries = App\Country::lists('name','id'); ?>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::select('country_id', $countries, $store->country_id, array('class' => 'form-control')) !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="row">
                            ...
                            <label class="checkbox-inline">
                                <input class="icheck" type="checkbox" <?= in_array($option->id, $store->paymentoptionstore()->getRelatedIds()) ? "checked" : "";?> name="paymentoption[]" value="{{ $option->id }}">
                                {{ $option->name }}
                            </label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::select('delivery_id[]', $countries, $store->deliverystore()->getRelatedIds(), array('class' => 'form-control', "multiple")) !!}
                    </div>
                </div>
              </form>
            </div>

    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="content">
                ...
                @endif
              <form class="form-horizontal group-border-dashed" role="form" action="{{ route('admin.paymentoptions.update', $paymentoption->id) }}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_method" value="PUT">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">Name</label>
                    <div class="col-sm-6">
                      <input type="name" class="form-control" id="name" name="name" value="{{$paymentoption->name}}" placeholder="insert payment option name">
                    </div>
                </div>
                <div class="form-group">

    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="content">
                ...
                <?php endif; ?>
              <form class="form-horizontal group-border-dashed" role="form" action="<?php echo e(route('admin.paymentoptions.update', $paymentoption->id)); ?>" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_method" value="PUT">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">Name</label>
                    <div class="col-sm-6">
                      <input type="name" class="form-control" id="name" name="name" value="<?php echo e($paymentoption->name); ?>" placeholder="insert payment option name">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                            <img class="" src="<?php echo e(asset("$paymentoption->img")); ?>" alt=""/>
                        </div>
                        <div>

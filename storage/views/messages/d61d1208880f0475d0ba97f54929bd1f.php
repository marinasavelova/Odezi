        ...
        <div class="col-md-12">
            ...
            <div class="content">
               <?php if($errors->all()): ?>
                ...
                <?php endif; ?>
              <form id="store-form" class="form-horizontal group-border-dashed" style="border-radius: 0px;" role="form" action="<?php echo e(action('StoreController@postStore') /*route('admin.countries.create')*/); ?>" method="POST" enctype="multipart/form-data">
               ...
               <?php $countries = App\Country::lists('name','id'); ?>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <?php echo Form::select('country_id', $countries, null, array('class' => 'form-control')); ?>
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="row">
                            ...
                            <label class="checkbox-inline">
                                <input class="icheck" type="checkbox" checked="" name="paymentoption[]" value="<?php echo e($option->id); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <?php echo Form::select('delivery_id[]', $countries, null, array('class' => 'form-control', "multiple")); ?>
